...
tags = [
    {"name": "Quick start", "description": """The most central API endpoints at a glance."""},
    {
        "name": "Image notes",
        "description": """Data points on the map, optionally associated with a photograph
    ...
    {"name": "Workplaces", "description": "Possible delivery destinations, along with delivery instructions."},
    {
        "name": "Workplace entrances",
        "description": """Objects connecting a particular workplace to a
    ...
    },
    {
        ...
        "description": """Recommended places to leave the vehicle while delivering goods to particular entrances.""",
    },
    {
        "name": "Entrances",
