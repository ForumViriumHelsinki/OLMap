...
from olmap.rest.permissions import IsReviewer, IsReviewerOrCreator, user_is_reviewer
from olmap.rest.schema import SchemaWithParameters
from olmap.rest.serializers import (
...
class OSMImageNoteCommentNotificationsViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    schema = AutoSchema(tags=["Image note comments"])
    queryset = (
        models.OSMImageNoteCommentNotification.objects.filter(seen__isnull=True)
