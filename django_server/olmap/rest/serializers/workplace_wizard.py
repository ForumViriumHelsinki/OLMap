...
class MapFeatureSerializer(serializers.ModelSerializer):
    ...
    image_note_id = serializers.PrimaryKeyRelatedField(queryset=models.OSMImageNote.objects.all(), required=False)
            ...
            "unloading_places": [
                {
                    ...
                    "access_points": [{"lat": 60.163633184821336, "lon": 24.951673150062565}],
                }
            ],
        },
        {"lat": 60.16367581809711, "lon": 24.951109886169437, "unloading_places": []},
    ],
}
...
class WorkplaceSerializer(MapFeatureSerializer):
    ...
    def update_entrances(self, workplace, entrances_data):
        ...
        for entrance_data in entrances_data:
            ...
            if id:
                entrance = workplace.workplace_entrances.select_related("entrance__image_note").get(id=id)
