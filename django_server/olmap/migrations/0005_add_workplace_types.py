...
types = [
    {"label": "Office", "osm_tags": {"office": "yes"}, "children": [
        {"label": "Association", "osm_tags": {"office": "association"}, "children": [], "synonyms": ["info"]},
        {"label": "Company", "osm_tags": {"office": "company"}, "children": [
            {"label": "Real estate", "osm_tags": {"office": "estate_agent"}, "children": [],
             "synonyms": ["apartment rent", "house shop", "brokerage"]},
            {"label": "Architect", "osm_tags": {"office": "architect"}, "children": [], "synonyms": ["architecture"]},
     ...
     "synonyms": []},
    {"label": "Shop", "osm_tags": {"shop": "yes"}, "children": [
        {"label": "Home furnishing", "osm_tags": {"shop": "yes"}, "children": [
            {"label": "Carpets", "osm_tags": {"shop": "carpet"}, "children": [], "synonyms": ["floors", "mats"]},
            {"label": "Antiques", "osm_tags": {"shop": "antiques"}, "children": [], "synonyms": ["antiikki"],
             "also_in": ["Second hand"]},
            {"label": "Houseware", "osm_tags": {"shop": "houseware"}, "children": [],
             "synonyms": ["cooking", "dishes"]},
            {"label": "Interior decoration", "osm_tags": {"shop": "interior_decoration"}, "children": [],
             "synonyms": ["design", "sisustus"]},
            {"label": "Furniture", "osm_tags": {"shop": "furniture"}, "children": [], "synonyms": ["huonekalut"]},
            {"label": "Picture frame shop / framing service", "osm_tags": {"shop": "frame"}, "children": [],
             "synonyms": ["kehystämö"]},
            {"label": "Bathroom furnishing", "osm_tags": {"shop": "bathroom_furnishing"}, "children": [],
             "synonyms": []},
            {"label": "Curtains", "osm_tags": {"shop": "curtain"}, "children": [], "synonyms": []},
            {"label": "Kitchen", "osm_tags": {"shop": "kitchen"}, "children": [], "synonyms": [],
             "also_in": ["Construction"]},
            {"label": "Pottery", "osm_tags": {"shop": "pottery"}, "children": [], "synonyms": []}
        ],
         "synonyms": []},
        {"label": "Creative arts shop", "osm_tags": {"shop": "yes"}, "also_in": ["Culture"], "children": [
            {"label": "Art", "osm_tags": {"shop": "art"}, "children": [], "synonyms": ["taide"]},
            {"label": "Books", "osm_tags": {"shop": "books"}, "children": [
                {"label": "Used books", "osm_tags": {"shop": "books", "second_hand": "only"}, "children": [], "synonyms": []}],
            ...
            {"label": "Musical instruments", "osm_tags": {"shop": "musical_instrument"}, "children": [], "synonyms": []},
            {"label": "Photography supplies & services", "osm_tags": {"shop": "photo"}, "children": [], "synonyms": []},
            {"label": "Arts & crafts", "osm_tags": {"shop": "craft"}, "children": [], "synonyms": []}
        ], "synonyms": []},
        {"label": "Clothes & accessories", "osm_tags": {"shop": "clothes"}, "children": [
            {"label": "Childrens clothes", "osm_tags": {"shop": "clothes", "clothes": "children"}, "children": [],
             "synonyms": ["lasten vaatekauppa"]},
            {"label": "Sports clothes", "osm_tags": {"shop": "clothes", "clothes": "sports"}, "children": [],
             "synonyms": ["urheiluvaatekauppa"]},
            {"label": "Hats", "osm_tags": {"shop": "clothes", "clothes": "hats"}, "children": [], "synonyms": []},
            {"label": "Dressmaker", "osm_tags": {"craft": "dressmaker"}, "children": [],
             "synonyms": ["wedding", "ompelija"]},
            {"label": "Second hand clothes", "osm_tags": {"shop": "clothes", "second_hand": "only"}, "children": [],
             "synonyms": [], "also_in": ["Second hand"]},
            {"label": "Tailor", "osm_tags": {"craft": "tailor"}, "children": [], "synonyms": [], "also_in": ["Service"]},
            {"label": "Underwear", "osm_tags": {"shop": "clothes", "clothes": "underwear"}, "children": [], "synonyms": []},
            ...
            {"label": "Gloves", "osm_tags": {"shop": "clothes", "clothes": "gloves"}, "children": [], "synonyms": []},
            {"label": "Fashion accessories", "osm_tags": {"shop": "fashion_accessories"}, "children": [], "synonyms": []},
            {"label": "Goldsmith", "osm_tags": {"craft": "goldsmith"}, "children": [], "synonyms": []}
        ], "synonyms": ["couture", "vaatekauppa"]},
        {"label": "Second hand", "osm_tags": {"shop": "second_hand"}, "children": [],
         "synonyms": ["flea market", "recycling shop"]},
        {"label": "Florist", "osm_tags": {"shop": "florist"}, "children": [], "synonyms": ["flowers"]},
        {"label": "Supermarket", "osm_tags": {"shop": "supermarket"}, "children": [],
        ...
        {"label": "Health & beauty", "osm_tags": {"shop": "beauty"}, "children": [
            {"label": "Chemist: drugs, hygiene, cosmetics, cleaning etc.", "osm_tags": {"shop": "chemist"}, "children": [], "synonyms": []},
            {"label": "Cosmetics", "osm_tags": {"shop": "cosmetics"}, "children": [], "synonyms": []},
            {"label": "Optician", "osm_tags": {"shop": "optician"}, "children": [], "synonyms": [], "also_in": ["Healthcare"]},
            {"label": "Hairdressing supplies", "osm_tags": {"shop": "hairdresser_supply"}, "children": [], "synonyms": []}],
         "synonyms": []},
        ...
        {"label": "Outdoor", "osm_tags": {"shop": "outdoor"}, "children": [
            {"label": "Fishing", "osm_tags": {"shop": "fishing"}, "children": [], "synonyms": []},
            {"label": "Hunting", "osm_tags": {"shop": "hunting"}, "children": [], "synonyms": []}
        ],
         "synonyms": []},
        {"label": "Sports", "osm_tags": {"shop": "sports"}, "children": [
            {"label": "Equestrian", "osm_tags": {"shop": "sports", "sport": "equestrian"}, "children": [], "synonyms": []},
            {"label": "Skates", "osm_tags": {"shop": "sports", "sport": "ice_skating"}, "children": [], "synonyms": []}
            ],
         "synonyms": []},
        {"label": "Construction", "osm_tags": {"shop": "hardware"},
         "children": [
            {"label": "Hardware", "osm_tags": {"shop": "hardware"}, "children": [], "synonyms": []},
            {"label": "Paint", "osm_tags": {"shop": "paint"}, "children": [], "synonyms": []},
            {"label": "Window construction", "osm_tags": {"craft": "window_construction"}, "children": [], "synonyms": []},
            {"label": "Glaziery (glass shop)", "osm_tags": {"craft": "glaziery"}, "children": [], "synonyms": []}],
         "synonyms": []},
    ...
    {"label": "Food & drink", "osm_tags": {"shop": "yes"}, "children": [
        ...
        {"label": "Restaurant", "osm_tags": {"amenity": "restaurant"}, "children": [],
         "synonyms": ["pizzeria", "ravintola"]}],
     "synonyms": []},
    {"label": "Healthcare", "osm_tags": {"healthcare": "yes"}, "children": [
        {"label": "Clinic", "osm_tags": {"amenity": "clinic", "healthcare": "clinic"}, "children": [],
         "synonyms": ["medical center"]},
        {"label": "Hospital", "osm_tags": {"amenity": "hospital", "healthcare": "hospital"}, "children": [], "synonyms": []},
        {"label": "Dentist", "osm_tags": {"amenity": "dentist", "healthcare": "dentist"}, "children": [], "synonyms": []},
        {"label": "Physiotherapist", "osm_tags": {"healthcare": "physiotherapist"}, "children": [],
         "synonyms": ["fysioterapia"]},
        {"label": "Pharmacy", "osm_tags": {"amenity": "pharmacy"}, "children": [], "synonyms": [], "also_in": ["Shop"]}
    ], "synonyms": []},
    {"label": "Service", "osm_tags": {"shop": "yes"}, "children": [
        {"label": "Funeral directors", "osm_tags": {"shop": "funeral_directors"}, "children": [],
         "synonyms": ["hautaustoimisto"]},
        {"label": "Repair service", "osm_tags": {"shop": "yes", "repair": "yes"}, "children": [
            {"label": "Bicycle repair", "osm_tags": {"shop": "bicycle", "repair": "yes"}, "children": [], "also_in": ["Bicycles"],
             "synonyms": ["bike repair"]},
            {"label": "Shoe repair", "osm_tags": {"shop": "shoe_repair"}, "children": [], "also_in": ["Shoes"],
             "synonyms": ["cobbler", "suutari"]},
            {"label": "Phone repair", "osm_tags": {"craft": "electronics_repair", "electronics_repair": "phone"},
             "children": [], "synonyms": [], "also_in": ["Second hand"]}
        ], "synonyms": []},
        ...
        {"label": "Bookbinder", "osm_tags": {"craft": "bookbinder"}, "children": [], "synonyms": [], "also_in": ["Books"]},
        {"label": "Beauty", "osm_tags": {"shop": "beauty"}, "children": [
            {"label": "Nail salon", "osm_tags": {"shop": "beauty", "beauty": "nails"}, "children": [], "synonyms": []},
            {"label": "Hairdresser", "osm_tags": {"shop": "hairdresser"}, "children": [],
             "synonyms": ["barber shop", "parturi", "hairsalon", "kampaamo"]},
            {"label": "Tattoo parlour", "osm_tags": {"shop": "tattoo"}, "children": [],
             "synonyms": ["body piercing"]},
            {"label": "Tanning salon / solarium", "osm_tags": {"leisure": "tanning_salon"}, "children": [], "synonyms": []}
        ], "synonyms": ["kauneushoitola", "spa", "skincare", "salon"]},
        {"label": "Laundry", "osm_tags": {"shop": "laundry"}, "children": [], "synonyms": []},
        {"label": "Locksmith", "osm_tags": {"craft": "locksmith"}, "children": [], "synonyms": [], "also_in": ["Shop"]},
        {"label": "Massage", "osm_tags": {"shop": "massage"}, "children": [], "synonyms": ["spa"]},
        {"label": "Photographer", "osm_tags": {"craft": "photographer"}, "children": [],
        ...
        {"label": "Fitness centre", "osm_tags": {"leisure": "fitness_centre"}, "children": [
            {"label": "Yoga studio", "osm_tags": {"leisure": "fitness_centre", "sport": "yoga"}, "children": [], "synonyms": []},
            {"label": "Taekwondo centre", "osm_tags": {"leisure": "fitness_centre", "sport": "taekwondo"}, "children": [], "synonyms": []}],
    ...
    {"label": "Culture", "osm_tags": {"amenity": "arts_centre"}, "children": [
    ...
    {"label": "Religion", "osm_tags": {"office": "religion"}, "children": [
        {"label": "Religious office", "osm_tags": {"office": "religion"}, "children": [], "synonyms": []},
        {"label": "Place of worship", "osm_tags": {"amenity": "place_of_worship"}, "children": [
            {"label": "Church", "osm_tags": {"amenity": "place_of_worship", "religion": "christian"}, "children": [], "synonyms": []}],
         "synonyms": []}],
     "synonyms": []},
    {"label": "Education", "osm_tags": {"amenity": "school"},
     "children": [
         ...
         {"label": "Dance school", "osm_tags": {"leisure": "dance", "dance:teaching": "yes"}, "children": [], "synonyms": []},
...
def forwards(apps, schema_editor):
    ...
    for Model in [Shop, Amenity, Office]:
        for i in Model.objects.all().select_related('image_note'):
            ...
            t = t_model_index.get(type_key, None)
            if not t:
            ...
            Workplace.objects.create(type=t, name=i.name, image_note=i.image_note,
                                     street=i.street, housenumber=i.housenumber, unit=i.unit,
                                     phone=i.phone, opening_hours=i.opening_hours, level=i.level)
