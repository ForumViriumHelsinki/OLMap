...
export default class OSMChangesetSelectionButton extends React.Component<OSMChangesetSelectionButtonProps, OSMChangesetSelectionButtonState> {
  ...
  render() {
    ...
    return <>
      ...
      <MapToolButton icon="compare_arrows"
