...
class OSMImageNotesEditor extends React.Component<OSMImageNotesEditorProps, OSMImageNotesEditorState> {
  ...
  render() {
    ...
    return <div className="flex-grow-1">
      <div className="position-absolute map-tools p-3">
        <NewOSMImageNote requestNoteType={newNote}
        ...
        {!selectLocation && <>
          ...
          <OSMChangesetSelectionButton selectedChangeset={selectedChangeset}
