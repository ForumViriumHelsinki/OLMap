...
export default class MapFeatureForm extends React.Component<MapFeatureFormProps, MapFeatureFormState> {
  ...
  render() {
    ...
    return <Form schema={filteredSchema} uiSchema={this.getUISchema()} className="compact"
                  formData={mapFeature}
                  onSubmit={onSubmit}>
              <Button size="sm" color="primary" type="submit" className="btn-compact pl-4 pr-4 mr-2">Done</Button>
