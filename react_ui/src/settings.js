const settings = {
  ...
  MapBox: {
    accessToken:
      ...
      'pk.eyJ1Ijoiam9oYW4tZnZoIiwiYSI6ImNrNDJtOGh5cDAxczIzb3FpdHg1Z3c5MGwifQ.bp9ubCm67HLIorEUb21K3A',
  },
  useMockGeolocation:
    process.env.REACT_APP_USE_MOCK_LOCATION === 'true'
      ? [
  ...
  overpassInterpreterPath:
    process.env.REACT_APP_OVERPASS_URL || 'https://overpass.fvh.io/api/interpreter',
