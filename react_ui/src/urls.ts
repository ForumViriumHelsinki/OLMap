...
export const acceptOSMImageNoteUrl = (id: number) =>
  `/rest/osm_image_notes/${id}/mark_accepted/`;
export const processedOSMImageNoteUrl = (id: number) =>
  `/rest/osm_image_notes/${id}/mark_processed/`;
export const reviewedOSMImageNoteUrl = (id: number) =>
  `/rest/osm_image_notes/${id}/mark_reviewed/`;
export const rejectOSMImageNoteUrl = (id: number) =>
  `/rest/osm_image_notes/${id}/hide_note/`;

export const upvoteOSMImageNoteUrl = (id: number) =>
  `/rest/osm_image_notes/${id}/upvote/`;
export const downvoteOSMImageNoteUrl = (id: number) =>
  `/rest/osm_image_notes/${id}/downvote/`;

export const osmImageNoteCommentsUrl = `/rest/osm_image_note_comments/`;
export const osmImageNoteCommentUrl = (id: number) =>
  `/rest/osm_image_note_comments/${id}/`;

export const notificationsUrl = `/rest/notifications/`;
export const notificationSeenUrl = (id: number) =>
  `/rest/notifications/${id}/mark_seen/`;
...
export const workplaceEntranceUrl = (id: number) =>
  `/rest/workplace_entrances/${id}/`;
export const workplaceUrl = (id: number) => `/rest/workplaces/${id}/`;

export const unloadingPlaceUrl = (id: number) =>
  `/rest/unloading_places/${id}/`;
